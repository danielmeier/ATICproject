...
static const mxArray *sf_get_sim_state_info_c1_model(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_model\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_modelInstanceStruct *chartInstance;
    chartInstance = (SFc1_modelInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c1_model((SFc1_modelInstanceStruct*) chartInstanceVar);
}
...
static void mdlProcessParameters_c1_model(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_model((SFc1_modelInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}
