...
static void sf_c3_model(SFc3_modelInstanceStruct *chartInstance);
  ...
  const mxArray *c3_st)
{
  ...
  *c3_y = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)),
  ...
  chartInstance->c3_is_active_c3_model = c3_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_model");
  sf_mex_destroy(&c3_u);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2336068966U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1780379056U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2951672645U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1569812470U);
}
...
mxArray *sf_c3_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HsCNhrjgk43wMzujnfqG4G");
...
static const mxArray *sf_get_sim_state_info_c3_model(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c3_model\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_modelInstanceStruct *chartInstance;
    chartInstance = (SFc3_modelInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c3_model((SFc3_modelInstanceStruct*) chartInstanceVar);
}
...
static void mdlProcessParameters_c3_model(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_model((SFc3_modelInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}
...
static void mdlSetWorkWidths_c3_model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(756908543U));
  ssSetChecksum1(S,(2484547400U));
  ssSetChecksum2(S,(818522370U));
  ssSetChecksum3(S,(4094224898U));
