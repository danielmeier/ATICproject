...
static void sf_c2_model(SFc2_modelInstanceStruct *chartInstance);
...
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_modelInstanceStruct *chartInstance,
  ...
  const mxArray *c2_st)
{
  ...
  *c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
    "y");
  chartInstance->c2_is_active_c2_model = c2_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 1)), "is_active_c2_model");
  sf_mex_destroy(&c2_u);
  ...
  const mxArray *c2_b_is_active_c2_model, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_model),
    &c2_thisId);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_modelInstanceStruct *chartInstance;
    chartInstance = (SFc2_modelInstanceStruct *) ((ChartInfoStruct *)
...
{
  sf_c2_model((SFc2_modelInstanceStruct*) chartInstanceVar);
}
...
static void mdlProcessParameters_c2_model(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_model((SFc2_modelInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}
