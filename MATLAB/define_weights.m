...
%  Noise weights
W_rhon = 0.025;  % 1=10 degrees > 0.025 equals 0.25 degrees
...
loglog(abs(W_rho_f),'-.',...
    ...
    abs(W_alphaperf_f),'-.')
grid
legend('W_{rho}','W_{alpha}','W_{noise}','W_{disturbances}','W_{rho,perf}','W_{alpha,perf}')
